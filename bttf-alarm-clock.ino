...
#define green2_DIO 15
#define green3_DIO 14
#define greenAM 27
#define greenPM 12
#define SET_STOP_BUTTON 34
#define SET_STOP_LED 26
#define SET_SOUND_BUTTON 4
#define SET_SOUND_LED 2
...
void handleApiTime(AsyncWebServerRequest *request) {
    ...
    if (!timeSynchronized || !getLocalTime(&timeinfo)){ 
        ...
        strftime(dateBuffer, sizeof(dateBuffer), "%d/%m/%Y", &timeinfo); // Day/Month/Year (e.g., 04/07/2025)
